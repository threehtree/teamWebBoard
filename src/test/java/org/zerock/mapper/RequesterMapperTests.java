...
public class RequesterMapperTests {
    ...
    public void testSelectList(){
        ...
        List<Requester> requesterList = requesterMapper.selectList(listDTO);
    ...
    public void testRequesterGetTotal(){
        ListDTO listDTO = new ListDTO();
        log.info(requesterMapper.requesterGetTotal(listDTO));

    }
    @Test
    public void testcolumnName(){
        log.info(Arrays.toString(requesterMapper.columnName()));
    }
